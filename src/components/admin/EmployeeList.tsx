      ...
      <div className="bg-gradient-to-br from-primary-start/10 to-primary-end/5 backdrop-blur-xl rounded-2xl p-6 border border-primary-start/20">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-800/70 text-sm">Manage organization employees and their information</p>
          </div>
      ...
      <div className="bg-gradient-to-br from-primary-start/10 to-primary-end/5 backdrop-blur-xl rounded-2xl border border-primary-start/20 overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gradient-to-br from-primary-start/10 to-primary-end/5 border-b border-primary-start/20">
                <tr>
                  <th className="px-6 py-4 text-left text-sm font-medium text-gray-800/80">Employee</th>
                  <th className="px-6 py-4 text-left text-sm font-medium text-gray-800/80">Employee Code</th>
                  <th className="px-6 py-4 text-left text-sm font-medium text-gray-800/80">Department</th>
                  <th className="px-6 py-4 text-left text-sm font-medium text-gray-800/80">Position</th>
              ...
              <tbody className="divide-y divide-white/10">
                {employees.map((employee) => (
                  <tr key={employee.id} className="hover:bg-gradient-to-br from-primary-start/10 to-primary-end/5 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-gray-800 font-medium">{employee.full_name}</div>
                          <div className="flex items-center space-x-1 text-gray-800/60 text-sm">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-gray-800/80 font-mono text-sm">{employee.employee_code}</span>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-2">
                        <Building className="w-4 h-4 text-gray-800/50" />
                        <span className="text-gray-800/80">{employee.department}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-gray-800/80">{employee.position}</span>
                    </td>
                    <td className="px-6 py-4">
        ...
        <div className="lg:hidden">
          <div className="p-4 space-y-4">
            {employees.map((employee) => (
              <div key={employee.id} className="bg-gradient-to-br from-primary-start/10 to-primary-end/5 rounded-xl p-4 border border-primary-start/20">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-gray-800 font-medium">{employee.full_name}</div>
                      <div className="text-gray-800/60 text-sm">{employee.employee_code}</div>
                    </div>
                  </div>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    employee.is_active 
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-800/80 text-sm">{employee.email}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Building className="w-4 h-4 text-gray-800/50" />
                    <span className="text-gray-800/80 text-sm">{employee.department}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <UserCheck className="w-4 h-4 text-gray-800/50" />
                    <span className="text-gray-800/80 text-sm">{employee.position}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Calendar className="w-4 h-4 text-gray-800/50" />
                    <span className="text-gray-800/80 text-sm">
