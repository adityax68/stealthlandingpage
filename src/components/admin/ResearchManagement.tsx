            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                {uploadSuccess && thumbnailUrl && (
                  <div className="flex items-center space-x-2 mb-3 p-3 bg-green-500/20 border border-green-500/30 rounded-lg">
                    <CheckCircle className="w-5 h-5 text-green-400" />
                    <span className="text-green-300 text-sm">Image uploaded successfully to S3!</span>
                  </div>
                )}
